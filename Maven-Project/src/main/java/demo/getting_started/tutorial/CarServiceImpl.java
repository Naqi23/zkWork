...
public class CarServiceImpl implements CarService{
	...
	@Override
	public void addCar(String model, String make, String description, String preview, Integer price, String color) {
		carList.add(new Car(this.id++, model, make, description, preview, price, color));
	}
